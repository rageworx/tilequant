...
#undef ARGMATCH
	...
	struct RGBAf_t     *Palette   = calloc(BMP_PALETTE_COLOURS, sizeof(struct RGBAf_t));
	...
	//! Output PSNR
#if MEASURE_PSNR
    //! -20*Log10[RMSE/255] == -20/Log[10] * Log[RMSE/255]
	RMSE.r = -8.68588963f*logf(RMSE.r / 255.0f);
	RMSE.g = -8.68588963f*logf(RMSE.g / 255.0f);
	RMSE.b = -8.68588963f*logf(RMSE.b / 255.0f); 
